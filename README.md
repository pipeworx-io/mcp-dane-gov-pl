...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/dane_gov_pl_search_datasets \
  -H 'Content-Type: application/json' \
  -d '{"q":"budżet"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/dane_gov_pl_search_datasets`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
